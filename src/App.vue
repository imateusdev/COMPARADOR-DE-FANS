<template>
  <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
    <header
      v-show="!selectedFans.length"
      class="bg-gradient-to-r from-blue-600 to-purple-600 shadow-lg sticky top-0 z-50"
    >
    ...
    <main class="max-w-[98%] mx-auto px-4 py-8">
      ...
      <footer class="mt-12 py-8 border-t border-gray-200 dark:border-gray-800">
        <div class="max-w-[98%] mx-auto">
          ...
          >
            <div
              class="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text"
            >
